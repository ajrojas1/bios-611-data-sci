...
knitr::opts_chunk$set(fig.width=11, fig.height=9, echo=FALSE, warning=FALSE, message=FALSE, results = "hide")
```
...
Over time, the monthly amoung of food pounds and clothing items has reduced over time. We can observe this in the yearly bar graphs that show the sum of food and clothes on a monthly basis. 
